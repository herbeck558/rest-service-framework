...
public class SwaggerSetup {
	...
	/**
	 * Return a list of REST classes needed for swagger support. These should then
	 * be added to the applications class set.
	 * 
	...
	/**
	 * Initialize swagger bean This is the "newer" way to initialize the swagger
	 * bean.
	 *
	 * @param title
	 *            Swagger title
	 ...
	 *            Packages to scan for REST APIs
	 * @param name
	 *            of the dark feature filter class
	 */
	public static void initializeSwaggerBean(String title, String description, String version, String apiBase,
			String swaggerPackages, String darkFeatureFilterClassName) {
